...
import 'package:testcase_dashboard/ui/focusable_search_bar.dart';
...
void main() {
  ...
  testWidgets('Ctrl+F opens side filters and focuses on artefact search bar',
    ...
    expect(find.byKey(focusableSearchBarKey), findsOneWidget);
    expect(focusableSearchBarKey.currentState?.focusNode.hasFocus, isTrue);
  });
}
