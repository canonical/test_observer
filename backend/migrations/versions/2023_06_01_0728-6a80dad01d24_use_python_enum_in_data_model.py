...
def upgrade() -> None:
    ...
    op.execute("ALTER TYPE artefact_status_enum RENAME VALUE 'Marked as Failed' TO 'MARKED_AS_FAILED'")

    op.execute("ALTER TYPE test_status_enum RENAME VALUE 'Not Started' TO 'NOT_STARTED'")
    op.execute("ALTER TYPE test_status_enum RENAME VALUE 'In Progress' TO 'IN_PROGRESS'")
...
def downgrade() -> None:
    op.execute("ALTER TYPE artefact_status_enum RENAME VALUE 'APPROVED' TO 'Approved'")
    op.execute("ALTER TYPE artefact_status_enum RENAME VALUE 'MARKED_AS_FAILED' TO 'Marked as Failed'")

    op.execute("ALTER TYPE test_status_enum RENAME VALUE 'NOT_STARTED' TO 'Not Started'")
    op.execute("ALTER TYPE test_status_enum RENAME VALUE 'IN_PROGRESS' TO 'In Progress'")
    op.execute("ALTER TYPE test_status_enum RENAME VALUE 'PASSED' TO 'Passed'")
    op.execute("ALTER TYPE test_status_enum RENAME VALUE 'FAILED' TO 'Failed'")
