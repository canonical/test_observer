...
def upgrade() -> None:
    ...
    op.execute("INSERT INTO reviewer_pool (name, families, created_at, updated_at) VALUES ('cert', ARRAY['snap', 'deb', 'image'], NOW(), NOW())")
    op.execute("INSERT INTO reviewer_pool (name, families, created_at, updated_at) VALUES ('sqa', ARRAY['charm'], NOW(), NOW())")
