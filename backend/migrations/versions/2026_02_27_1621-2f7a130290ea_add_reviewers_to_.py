...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["artefact_build_environment_review.id"],
            name=op.f("environment_review_reviewers_association_environment_review_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["app_user.id"],
            name=op.f("environment_review_reviewers_association_user_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "environment_review_id", "user_id", name=op.f("environment_review_reviewers_association_pkey")
        ),
    )
