...
def upgrade() -> None:
    ...
    op.add_column(
        "test_execution_rerun_request",
        sa.Column("artefact_build_id", sa.Integer(), nullable=True),
    )
    op.add_column(
        "test_execution_rerun_request",
    ...
    op.drop_constraint(
        "test_execution_rerun_request_test_execution_id_key",
        "test_execution_rerun_request",
        type_="unique",
    )
