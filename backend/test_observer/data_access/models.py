...
class TestExecutionRerunRequest(Base):
    ...
    test_execution_id: Mapped[int] = mapped_column(ForeignKey("test_execution.id", ondelete="CASCADE"), unique=True)
    test_execution: Mapped["TestExecution"] = relationship(back_populates="rerun_request")
