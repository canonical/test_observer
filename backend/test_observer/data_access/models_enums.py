...
class TestExecutionReviewStatus(str, Enum):
    ...
    APPROVED_INCONSISTENT_TEST_DEF = "APPROVED_INCONSISTENT_TEST_DEF"
    APPROVED_UNSTABLE_PHSYICAL_INFRA = "APPROVED_UNSTABLE_PHSYICAL_INFRA"
    APPROVED_FAULTY_HARDWARE = "APPROVED_FAULTY_HARDWARE"
    APPROVED_GENERIC = "APPROVED_GENERIC"
