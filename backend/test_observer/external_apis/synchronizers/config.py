...
class SyncConfig:
    ...
    OPEN_ISSUE_INTERVAL = int(environ.get("SYNC_OPEN_INTERVAL_S", DEFAULT_OPEN_INTERVAL_S))
    RECENT_CLOSED_INTERVAL = int(environ.get("SYNC_RECENT_CLOSED_INTERVAL_S", DEFAULT_RECENT_CLOSED_INTERVAL_S))
    OLD_CLOSED_INTERVAL = int(environ.get("SYNC_OLD_CLOSED_INTERVAL_S", DEFAULT_OLD_CLOSED_INTERVAL_S))
    OLD_CLOSED_THRESHOLD_DAYS = int(environ.get("SYNC_OLD_CLOSED_THRESHOLD_DAYS", DEFAULT_OLD_CLOSED_THRESHOLD_DAYS))
