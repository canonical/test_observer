...
class TestUsersMe:
    ...
    def _create_session_cookie(self, session_id: int) -> str:
    ...
    def test_get_me_without_csrf_token_returns_none(
        ...
        session_cookie = self._create_session_cookie(session.id)
    ...
    def test_get_me_without_session_returns_none(self, test_client: TestClient):
    ...
    def test_get_me_with_nonexistent_session_returns_none(
        ...
        session_cookie = self._create_session_cookie(999999)  # Non-existent session ID
        test_client.cookies.set("session", session_cookie)
