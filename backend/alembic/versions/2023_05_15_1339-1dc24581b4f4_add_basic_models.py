...
Revision ID: 1dc24581b4f4
Revises:
Create Date: 2023-05-15 13:39:51.828236+00:00
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('Not Started', 'In Progress', 'Passed', 'Failed', 'Not Tested', name='test_status_enum'), nullable=False),
