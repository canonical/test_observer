...
Revision ID: 092883a5d838
Revises: 
Create Date: 2023-05-02 09:36:16.845219+00:00
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_lane_name'), 'lane', ['name'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_table('page')
    op.drop_index(op.f('ix_lane_name'), table_name='lane')
    op.drop_table('lane')
